...
# ——— CONFIG ———
INPUT_JSON        = Path("biostars_with_gemma3.json")  # has model_answer + classification
OUTPUT_JSON       = Path("biostars_judged_gemma3.json")
...
"""
    ...
    try:
        ...
        return {"acceptable": False, "justification": ""}
